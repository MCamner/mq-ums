# Claude Instructions For mq-ums
...
For work related to `mq-ums`:

0. Read `.mq/context/task-pack.md` if it exists and matches the task.
1. Read `$MQ_OBSIDIAN_DIR/memory/learn/agent/mq-ums.md` if it exists.
2. Read `$MQ_OBSIDIAN_DIR/systems/mq-ums/hot.md` if it exists.
3. Read `$MQ_OBSIDIAN_DIR/systems/mq-ums/index.md` if it exists.
4. Read `$MQ_OBSIDIAN_DIR/memory/learn/repos/mq-ums.md` if it exists.
